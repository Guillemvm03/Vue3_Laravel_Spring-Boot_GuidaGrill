<template>
  ...
  <form id="contact" action="" method="post">
    ...
    Date:
    <VueDatePicker
    v-model="state.bookingLocal.date"
    ...
    <fieldset>
    Message:
      <textarea v-model="state.bookingLocal.msg" placeholder="Type your Message Here...." tabindex="5" required></textarea>
    </fieldset>
    <fieldset>
      <button @click="setValues" name="submit" type="button" id="contact-submit" data-submit="...Sending">Submit</button>
    </fieldset>
  </form>
...
setup(props) {
    ...
    const setValues = () => {
        ...
        // state.updatebooking.capacity = state.bookingLocal.capacity;
        // state.updatebooking.msg = state.bookingLocal.msg;
        // state.updatebooking.reservationDay = state.bookingLocal.reservationDay;
        // state.updatebooking.reservationTime = state.bookingLocal.reservationTime;
    };
